        ...
        <div class="container">
            <div class="row content-space-1">
                ...
                <div class="col-sm mb-7 mb-sm-0">
                    <span class="text-cap text-primary-light">Trade crypto</span>
                    <ul class="list-unstyled list-py-1 mb-0">
                        <li><a class="link-sm link-light" href="#">Bitcoin</a></li>
                        <li><a class="link-sm link-light" href="#">Exchange</a></li>
                        <li><a class="link-sm link-light" href="#">Buy Crypto</a></li>
                        <li><a class="link-sm link-light" href="#">Support <i class="bi-box-arrow-up-right ms-1"></i></a></li>
                        <li><a class="link-sm link-light" href="#">Reviews</a></li>
                    </ul>
                </div>

                <div class="col-sm mb-7 mb-sm-0">
                    <span class="text-cap text-primary-light">About us</span>
                    <ul class="list-unstyled list-py-1 mb-0">
                        <li><a class="link-sm link-light" href="#">About <i class="bi-box-arrow-up-right ms-1"></i></a></li>
                        <li><a class="link-sm link-light" href="#">News</a></li>
                ...
                <div class="col-sm">
                    ...
                    <ul class="list-unstyled list-py-1 mb-5">
                        <li><a class="link-sm link-light" href="#">Terms and condition</a></li>
                        <li><a class="link-sm link-light" href="#">Privacy notice <i class="bi-box-arrow-up-right ms-1"></i></a></li>
                    </ul>
